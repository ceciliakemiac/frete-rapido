...
func TestGetMetricsNoLastQuotes(t *testing.T) {
	...
	mock.ExpectQuery(regexp.QuoteMeta(
		...
		WillReturnRows(sqlmock.NewRows([]string{"nome", "servico", "prazo_entrega", "valor"}).AddRow("FR EXPRESS (TESTE)", "Normal", 5, 72.5))
	...
	mock.ExpectQuery(regexp.QuoteMeta(
		...
		WillReturnRows(sqlmock.NewRows([]string{"nome", "servico", "prazo_entrega", "valor"}).AddRow("EXPRESSO FR (TESTE)", "Normal", 5, 101.17))
	...
	if w.Body.String() != `{"fretes":[{"transportadora":"FR EXPRESS (TESTE)","total_ocorrencias":2,"total_precos":160.41,"media_precos":80.205},{"transportadora":"RAPIDÃO FR (TESTE)","total_ocorrencias":1,"total_precos":74.25,"media_precos":74.25},{"transportadora":"EXPRESSO FR (TESTE)","total_ocorrencias":1,"total_precos":101.17,"media_precos":101.17}],"frete_mais_caro":{"nome":"EXPRESSO FR (TESTE)","servico":"Normal","prazo_entrega":5,"valor":101.17},"frete_mais_barato":{"nome":"FR EXPRESS (TESTE)","servico":"Normal","prazo_entrega":5,"valor":72.5}}` {
...
func TestMetricsLastQuotes(t *testing.T) {
	...
	mock.ExpectQuery(regexp.QuoteMeta(
		...
		WillReturnRows(sqlmock.NewRows([]string{"total_ocorrencias", "transportadora", "total_precos", "media_precos"}).AddRow(1, "FR EXPRESS (TESTE)", 87.91, 87.91).AddRow(1, "EXPRESSO FR (TESTE)", 101.17, 101.17))
	...
	mock.ExpectQuery(regexp.QuoteMeta(
		...
		WillReturnRows(sqlmock.NewRows([]string{"nome", "servico", "prazo_entrega", "valor"}).AddRow("FR EXPRESS (TESTE)", "Express", 4, 87.91))
	...
	if w.Body.String() != `{"fretes":[{"transportadora":"FR EXPRESS (TESTE)","total_ocorrencias":1,"total_precos":87.91,"media_precos":87.91},{"transportadora":"EXPRESSO FR (TESTE)","total_ocorrencias":1,"total_precos":101.17,"media_precos":101.17}],"frete_mais_caro":{"nome":"EXPRESSO FR (TESTE)","servico":"Normal","prazo_entrega":5,"valor":101.17},"frete_mais_barato":{"nome":"FR EXPRESS (TESTE)","servico":"Express","prazo_entrega":4,"valor":87.91}}` {
		t.Error("Did not get right response, got ", w.Body.String())
	}
